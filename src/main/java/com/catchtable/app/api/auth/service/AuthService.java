package com.catchtable.app.api.auth.service;

import com.catchtable.app.api.auth.DTO.SignUpParam;
import com.catchtable.app.api.auth.domain.TokenEntity;
import com.catchtable.app.api.auth.repository.TokenRepository;
    ...
    public TokenEntity signIn(String username, String password) {
        UserEntity user = userRepository.findByUserName(username)
                                        .orElseThrow(() -> new AuthException(
                                            AuthErrorCode.WRONG_USERNAME_OR_PASSWORD));
