package com.catchtable.app.api.auth.controller;

import com.catchtable.app.api.auth.DTO.SignInRequestDTO;
import com.catchtable.app.api.auth.DTO.SignUpRequestDTO;
import com.catchtable.app.api.auth.DTO.TokenDTO;
import com.catchtable.app.api.auth.domain.TokenEntity;
import com.catchtable.app.api.auth.service.AuthService;
...
public class AuthController {
    ...
    public SuccessResponse<TokenDTO> singInUser(@RequestBody SignInRequestDTO signInRequestDTO) {
        TokenEntity token = authService.signIn(signInRequestDTO.getUserName(),
